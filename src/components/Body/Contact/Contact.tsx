        ...
        <div className="flex">
            <a href={link} target="_blank">
                <div className="group flex items-center gap-x-3">
                    ...
                    <p className="text-palette-white group-hover:group-hover-white-text-shadow text-2xl">
                        {text}
                    </p>
                </div>
            </a>
...
export default function Contact() {
    return (
        <div id="contact" className="section relative h-screen snap-start">
            <div className="fullscreen-green-glow" />
            <div className="container mx-auto flex h-full flex-col pt-32">
                ...
                <div className="mt-24 flex h-full flex-1 items-stretch px-4">
                    ...
                    <div className="flex-1">
                        <form className="w-full">
                            <div className="flex flex-col gap-y-2">
                                ...
                                <label
                                    htmlFor="email"
                                    className="text-palette-white peer-focus:group-hover-white-text-shadow text-xl transition-all"
                                >
                                    Email:
                                </label>
                            </div>
                            ...
                            <div className="mt-8">
                                <button className="text-palette-black border-palette-yellow bg-palette-yellow hover:bg-palette-black hover:text-palette-yellow w-full border-2 py-4 text-xl font-bold">
                                    Submit
                                </button>
                            </div>
                        </form>
